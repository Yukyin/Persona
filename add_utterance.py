...
featrs=['','姓名','性别','年龄','籍贯','生日','属相','星座','身高','体重','外形','血型','爸爸','妈妈','工作内容','工作地点','学历','社交媒体','家族成员','语言','宗教','性取向','价值观','恋爱观','兴趣','偶像','特长','性格','食物','梦想','缺点','不喜欢的人','不喜欢做的事','害怕的内容','害怕做的事','喜欢的内容','喜欢的人','喜欢做的事','想去做的事','去过的地方','身体的小问题','用户的原则、底线','宠物','孩子','昵称','毕业院校','恋爱状况','结婚状况']
fea2id={}

for i in range(1,len(featrs)):
    fea2id[featrs[i]]=i
...
ques=[[],
    [],
    ['你是 男生 还是 女生 ？','你是 男 是 女 ？','你是 小哥哥 还是 小姐姐 ？','你是 帅哥 还是 美女 ？','你是 汉子 还是 妹子 ？','你是 男生 吗 ？','你是 女生 吗 ？','你 是 小哥哥 吗 ？','你 是 小姐姐 吗 ？','你 是 帅哥 吗 ？','你 是 美女 吗 ？','你 是 汉子 吗 ？','你 是 妹子 吗 ？','你 是 妹纸 吗 ？','你 是 汉纸 吗 ？','你的 性别 是 ？'],
    ['你今年 多大 了？','你今年 几岁 了？','你今年 多少岁 ？','你的 年龄 是？'],#3 年龄
    ['你 家 在哪里 ？','你 来自 哪里的？','你 家乡 在哪里 ？','你 祖籍 在哪里 ？','你 籍贯 在哪里？'],#4 籍贯
    ['你 生日 什么时候 ？','你 几月几号 生日？','你 几月几号 出生 ？'],
    ['你 属 什么的？','你 属相 是什么？'],
    ['你什么 星座 ？'],
    ['你 身高 多少？','你有 多高 ？'],#8 身高
    ['你 体重 多少？','你有 多重 ？'],#9 体重
    ['你 长得 怎么样？','别人 怎么 评价 你的 外表 ？','别人 怎么 评价 你的 外貌 ？','别人 怎么 评价 你的 外形 ？'],
    ['你是什么 血型 ？'],
    [],
    [],
    ['你是 做什么 工作 的？','你的 工作 是什么？','你的 职业 是什么？','你的 做什么的 ？'],
    ['你在哪 工作？','你在哪家 公司 ？'],
    ['你的 学历 怎么样？'],
    ['你喜欢 用什么 社交软件 ？','你喜欢 用什么 社交媒体 ？','你喜欢 用什么 App ？'],
    ['你 家 都有 谁 ？','你 家 有哪些 成员 ？'],
    ['你会 什么 语言 ？'],
    ['你 信奉 什么 宗教 ？','你 信奉 什么 教 ？'],
    ['你的 性取向 是什么？'],
    ['你的 价值观 是什么？'],
    ['你的 恋爱观 是什么？'],
    ['你有 什么 兴趣 ？','你平时 喜欢做什么 ？','你有什么 爱好 ？'],
    ['你的 偶像 是谁？','你的 爱豆 是谁？'],
    ['你有什么 特长 ？','你 擅长 什么？','你有什么 拿手 的事情？'],
    ['你的 性格 怎么样？'],
    ['你喜欢 什么 食物 ？','你喜欢 吃 什么？'],
    ['你有什么 愿望 ？','你有什么 理想 ？','你有什么 梦想 ？','你有什么 憧憬 ？','你有什么 期待 ？'],
    ['你有什么 缺点 ？','你有什么 短板 ？','你有什么 不好的地方 ？'],
    ['你 不喜欢的人 是谁？','你 讨厌谁 ？','你 厌烦谁 ？','你觉得 谁最烦人 ？'],
    ['你 不喜欢的事 是什么？','你 讨厌什么 ？','你 厌烦什么 ？','你觉得 什么事最烦人 ？'],#32 不喜欢做的事
    ['你 害怕 什么？','你 畏惧 什么？','你 恐慌 什么？'],
    ['你 害怕 什么？','你 畏惧 什么？','你 恐慌 什么？'],
    ['你 喜欢 什么？'],
    ['你 喜欢的人 是谁？','你 喜欢谁 ？','你 钟意谁 ？','你 爱谁 ？'],
    ['你 喜欢做什么 ？','你 爱做什么 ？'],
    ['你 想做什么 ？'],#38 想去做的事
    ['你 去过哪些地方 ？','你 去过哪里 ？','你 去过的地方 有哪些？'],
    ['你 身体上 有什么小问题 ？','你有什么 小病 吗？'],
    ['你的 原则和底线 是什么？'],
    ['你养 宠物 吗？'],
    ['你有 孩子 吗？'],
    [],#44 昵称（忽略）
    ['你 毕业 于哪里？','你之前在哪里 读书 ？'],
    ['你有 对象 吗？','你 单身 吗？','你 恋爱 了吗？'],
    ['你 结婚 了吗？','你 成家 了吗？'],
]

answ=[[],
    [],
    ['我是[MASK]生。','我是[MASK]孩子。','我是[MASK]孩。','我是[MASK]人。'],
    ['我今年[MASK]了。','我[MASK]了。'],#3 年龄
    ['我家在[MASK]。','我籍贯在[MASK]。','我祖籍在[MASK]。','我家乡在[MASK]。','我从[MASK]来的。','我来自[MASK]。'],#4 籍贯
    ['我生日是[MASK]。','我[MASK]出生的。'],
    ['我属[MASK]。'],
    ['我是[MASK]。'],
    ['我身高[MASK]。','我高[MASK]。'],#8 身高
    ['我体重[MASK]。','我重[MASK]。'],#9 体重
    ['我长得[MASK]。'],
    ['我是[MASK]型血。'],
    [],
    [],
    ...
    ['我的价值观是[MASK]。'],
    ['我的恋爱观是[MASK]。'],
    ['我喜欢[MASK]。','我的兴趣是[MASK]。','我的爱好是[MASK]。'],
    ['我的偶像是[MASK]。','我的爱豆是[MASK]。'],
    ['我的特长是[MASK]。','我擅长[MASK]。','我拿手[MASK]。'],
    ['我是一个[MASK]的人。'],
    ['我喜欢吃[MASK]。'],
    ['我的梦想是[MASK]。','我的理想是[MASK]。','我的愿望是[MASK]。','我憧憬[MASK]。','我期盼[MASK]。'],
    ['我的缺点是[MASK]。','我的短板[MASK]。','我不好的地方是[MASK]。'],
    ['我不喜欢[MASK]。','我讨厌[MASK]。','我厌烦[MASK]。','我觉得[MASK]最烦人。'],
    ['我不喜欢[MASK]。','我讨厌[MASK]。','我厌烦[MASK]。','我觉得[MASK]最烦人。'],#32 不喜欢做的事
    ['我害怕[MASK]。','我畏惧[MASK]。','我恐慌[MASK]。'],
    ['我害怕[MASK]。','我畏惧[MASK]。','我恐慌[MASK]。'],
    ['我喜欢[MASK]。'],
    ['我喜欢的人是[MASK]。','我钟意[MASK]。','我爱[MASK]。','我喜欢[MASK]。'],
    ['我喜欢做[MASK]。','我钟意[MASK]。','我爱做[MASK]。','我喜欢[MASK]。'],
    ['我想[MASK]。','我希望[MASK]。','我期待[MASK]。','我憧憬[MASK]。'],#38 想去做的事
    ['我去过[MASK]。','我去过的地方有[MASK]。'],
    ['我有[MASK]的症状。'],
    ['我的原则和底线是[MASK]。'],
    ['我养了一只[MASK]。'],
    ['我[MASK]。'],
    [],#44 昵称（忽略）
    ['我毕业于[MASK]。','我之前在[MASK]读书。'],
    ['我[MASK]。'],
    ['我[MASK]。'],
]
negf={30,31,32,33,34,40}
trans1p=['挺不错的','很棒','真好','哇哦','这样也可以','这样也挺好的','优秀','哈哈哈','确实挺好的','你很厉害','你说的有道理']
trans1n=['啊没事的','摸摸头','别担心','会好的','别怕','没关系']
trans2=['嗯']
dicR,dicU,udic={},{},{}
...
def ins(stid:int,dic:dict,ikey:str,flgstr:str,st1,st2):
    if dic.get(ikey,-1)== -1:
        return ([],[],[])
    res=[]
    lf=[]
    las=stid
    ftrs=set()
    for k2 in dic[ikey].keys():
        id=fea2id[k2]
        ftrs.add(id)
        #print(ikey,k2,id)
        s1=st1+rnd.choice(trans1n if las in negf else trans1p)+'，'+rnd.choice(trans2)+' '+rnd.choice(ques[id])
        nowf=rnd.choice(dic[ikey][k2])
        lf.append(k2+'='+nowf)
        s2=st2+rnd.choice(answ[id]).replace('[MASK]',nowf)+flgstr
        res.extend([s1,s2])
        las=id
    return (res,ftrs,lf)
        
def checkR2U(slst:list,f0:list,f1:list):
    if '[U]' in slst[1]:
        return (slst,[])
    nlst,nf=slst.copy(),[]
    for (i,x) in enumerate(slst):
        if i%2==1:
            nowftr=f1[i//2]
            flg=0
            if nowftr in udic.keys():
                for x in f0:
                    if x in udic[nowftr]:
                        flg=1
                        break
...
def solve(strlst:list):
    ...
    for i in range(len(strlst)) : 
        if type(strlst[i]) is list:
            for tp in strlst[i]:
                strb=check(tp,strlst[i-1].split())
                #print(tp,strb)
                k1=featrs[tp]+'='+strb
                st1,st2='',''
                if strlst[i-1].split()[0]=='p1:' :
                    st1,st2='p2: ','p1: '
                elif strlst[i-1].split()[0]=='p2:' :
                    st1,st2='p1: ','p2: '
                elif strlst[i-1].split()[0]=='Bot:' :
                    st1,st2='Usr: ','Bot: '
                else :
                    st2,st1='Usr: ','Bot: '
                ...
                for i in range(2):
                    if i==0:
                        r1,f1,l1=ins(tp,dicR,k1,'[R]',st1,st2)
                    else :
                        r1,f1,l1=ins(tp,dicU,k1,'[U]',st1,st2)
                    if len(r1):
                        if len(lstlst) == 0 :
                            curlst=newlst.copy()
                            nr,nl=checkR2U(r1,[k1],l1)
                            curlst.extend(nr)
                            l1=[k1]
                            l1.extend(nl)
                            lstlst.append((curlst,f1,l1))
                        else :
                            flg=0
                            for (x,f,l0) in lstlst:
                                if len(f&f1)>0:
                                    continue
                                nr,nl=checkR2U(r1,l0,l1)
                                x.extend(nr)
                                f=f|f1
                                l0.extend(nl)
                                flg=1
            ...
            for (x,f,l1) in lstlst:
                x.append(strlst[i])
            newlst.append(strlst[i])
    #print(newlst)
    for (x,f,l1) in lstlst:
        ans.append(x)
...
with open('plato-knowledge.json',encoding='UTF-8') as f:
    tot=json.load(f)
    for cur in tot:
        x=cur[0]
        y=cur[1].split('=')
        z=y[1]
        y=y[0]
        if type(dicR.get(x,-1)) is not dict:
            dicR[x]={}
        if type(dicR[x].get(y)) is not list:
            dicR[x][y]=[]
        dicR[x][y].append(z)

with open('unreason_plato-knowledge.json',encoding='UTF-8') as f:
    tot=json.load(f)
    for cur in tot:
        x=cur[0]
        y=cur[1].split('=')
        z=y[1]
        y=y[0]
        if type(dicU.get(x,-1)) is not dict:
            dicU[x]={}
        if type(dicU[x].get(y)) is not list:
            dicU[x][y]=[]
        dicU[x][y].append(z)
        if type(udic.get(cur[1],-1)) is not list:
            udic[cur[1]]=[]
        udic[cur[1]].append(x)

with open('labled.json',encoding='UTF-8') as f:
    cnt=0
...
c1,c2,c3,c4,c5=[],[],[],[],[]
for (i,dialg) in enumerate(ans):
    for (j,nows) in enumerate(dialg):
        nows=nows.split(':')
        if len(nows)==1:
            continue
        lbl=0
    ...
    if i==int(0.7*tot):
        sep=len(c1)
    if (i+1)%3000==0:
        print("{}/{} : {}".format(i+1,tot,len(c1)))
        
df=pd.DataFrame({'Dialogue_id':c1,'Utterance_id':c2,'Speaker':c3,'Sentence':c4,'Label':c5})
train_df=df[:sep]
test_df=df[sep:]
